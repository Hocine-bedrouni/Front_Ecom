...
const CartSecondStepRegisterForm = ({setShowRegisterForm}) => {
    ...
    return (
        <Formik initialValues={initialValues} validationSchema={validationSchema} onSubmit={handleSubmit}>
            <Form className='font-manuale flex flex-col gap-5 border border-zinc-300 p-10 text-dark'>
                <a onClick={() => setShowRegisterForm(false)} className='font-medium text-blue-600 hover:underline'>
                &lt; Retour
                </a>
                <RegisterInputs />
...
export default CartSecondStepRegisterForm;