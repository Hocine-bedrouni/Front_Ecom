...
const CheckIcon = ({width = 15, height = 15}) => {
  return (
    <svg fill="#aca5a5" width={width} height={height} version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 78.369 78.369" xmlSpace="preserve" stroke="#aca5a5">
